...
public class AgendaControllerTest {
	...
	public void testAddAgendaItem() throws Exception {
		...
		mockMvc.perform(post("/api/meetings/" + ID_MEETING + "/items").header("X-Auth-Token", accessToken)
	...
	public void testAddAgendaItemBadRequest() throws Exception {
		...
		mockMvc.perform(post("/api/meetings/" + ID_MEETING_NOT_FOUND + "/items").header("X-Auth-Token", accessToken)
	...
	public void testGetAgendaItem() throws Exception {
		mockMvc.perform(
				get("/api/meetings/" + ID_MEETING + "/items/" + ID.intValue()).header("X-Auth-Token", accessToken))
				.andExpect(status().isOk()).andExpect(content().contentType(contentType))
				.andExpect(jsonPath("$.title").value(TITLE)).andExpect(jsonPath("$.number").value(NUMBER));

	}

	@Test
	public void testGetAgendaItemNotFound() throws Exception {
		mockMvc.perform(get("/api/meetings/" + ID_MEETING + "/items/" + ID_ITEM_NOT_FOUND.intValue())
	...
	public void testGetAgendaItemBadRequest() throws Exception {
		mockMvc.perform(get("/api/meetings/" + ID_MEETING_NOT_FOUND + "/items/" + ID.intValue()).header("X-Auth-Token",
	...
	public void testDeleteAgendaItem() throws Exception {
		mockMvc.perform(
				delete("/api/meetings/" + ID_MEETING + "/items/" + ID.intValue()).header("X-Auth-Token", accessToken))
	...
	public void testDeleteAgendaItemNotFound() throws Exception {
		mockMvc.perform(delete("/api/meetings/" + ID_MEETING + "/items/" + ID_ITEM_NOT_FOUND.intValue())
				.header("X-Auth-Token", accessToken)).andExpect(status().isNotFound());
	}
	...
	public void testDeleteAgendaItemBadRequest() throws Exception {
		mockMvc.perform(delete("/api/meetings/" + ID_MEETING_NOT_FOUND + "/items/" + ID.intValue())
	...
	public void testUpdateAgendaItemBadRequest() throws Exception {
		...
		mockMvc.perform(put("/api/meetings/" + ID_MEETING_NOT_FOUND + "/items/" + ID)
	...
	public void testUpdateConclusionAgenda() throws Exception {
		...
		mockMvc.perform(put("/api/meetings/" + ID_MEETING + "/items/" + ID + "/conclusion")
				.header("X-Auth-Token", accessToken).contentType(contentType).content(json)).andExpect(status().isOk())
				.andExpect(content().contentType(contentType))
